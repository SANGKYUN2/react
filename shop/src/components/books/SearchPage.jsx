        ...
        <div className='my-5'>
            ...
            <Row className='mb-2'>
                ...
                <Col className='text-end'>
                    <Button variant="success" onClick={onInsertChecked}>선택 도서 저장</Button>
                </Col>
            </Row>
            <Table striped bordered hover className='align-middle text-center' variant='success'>
                ...
                <tbody>
                    {books.map(book =>
                        <tr key={book.isbn}>
                            ...
                            <td>{book.title}</td>
                            <td className='text-center'>{book.price}원</td>
                            <td>{book.authors}</td>
                            <td className='text-center'><Button variant="warning" onClick={() => onInsert(book)} size='sm'>등록</Button></td>
                        </tr>
                    )}
                </tbody>
            </Table>
            <div className='text-center'>
                <Button variant="warning" onClick={() => setPage(page - 1)} disabled={page === 1}>이전</Button>
                <span className='mx-3'>{page}</span>
                <Button variant="success" onClick={() => setPage(page + 1)} disabled={isEnd}>다음</Button>
            </div>
        </div>
    )
}
