...
const UpdatePage = () => {
    ...
    return (
        <div>
            <h1 className='text-center my-3'>상품 정보 수정</h1>
            <Card className='my-3'>
                <Card.Body>
                    <Row className='justify-content-center'>
                        ...
                        <Col>
                            <InputGroup className='mb-2'>
                                <InputGroup.Text>상품 코드</InputGroup.Text>
                                <Form.Control value={gid} name='gid' readOnly={true}/>
                            </InputGroup>
                            <InputGroup className='mb-2'>
                                <InputGroup.Text>상품 이름</InputGroup.Text>
                                <Form.Control onChange={onChangeForm}
                                    value={title} name='title' />
                            </InputGroup>
                            <InputGroup className='mb-2'>
                                <InputGroup.Text>상품 가격</InputGroup.Text>
                                <Form.Control onChange={onChangeForm}
